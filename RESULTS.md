...
## 1. Stage 2 — Multi-class

เทรน 2 แบบ: `attack_only` (7 คลาส) และ `with_normal` (8 คลาส)

### attack อย่างเดียว (7 คลาส)

|              |   accuracy |   precision |   recall |     f1 |   latency (ms/1k) |
|:-------------|-----------:|------------:|---------:|-------:|------------------:|
| XGBoost      |     0.9987 |      0.9535 |   0.9664 | 0.9563 |            1.0685 |
| DecisionTree |     0.9981 |      0.9303 |   0.9751 | 0.95   |            0.3308 |
| RandomForest |     0.9982 |      0.8884 |   0.8736 | 0.8779 |            1.3277 |

### มี Normal ด้วย (8 คลาส)

|              |   accuracy |   precision |   recall |     f1 |   latency (ms/1k) |
|:-------------|-----------:|------------:|---------:|-------:|------------------:|
| XGBoost      |     0.999  |      0.9491 |   0.9373 | 0.9423 |            1.1759 |
| DecisionTree |     0.998  |      0.9214 |   0.9359 | 0.9285 |            0.2264 |
...
macro-F1 ของสองแบบเทียบกันตรง ๆ ไม่ได้เพราะจำนวนคลาสไม่เท่ากัน
การตัดสินว่าแบบไหนดีกว่าอยู่ที่หัวข้อ 3 (ฟีเจอร์จากแบบไหนทำให้ stage 1 ดีกว่า)
...
ชื่อชุดอ่านว่า `<แหล่ง SHAP>_<วิธีรวม>` — กริดเต็ม 2 แกน:

| ชุด | SHAP มาจาก | ตอบคำถาม |
|---|---|---|
| `attack7_*` | stage 2 (7 คลาส) | แยกชนิด attack |
| `normal8_*` | stage 2 (8 คลาส) | แยกชนิด attack + แยกจาก Normal |
| `binary_*` | โมเดล binary | แยก Normal จาก Attack (เพดานอ้างอิง) |

ส่วนหลัง `_` คือวิธีรวมข้ามคลาส: `union` / `intersection` / `mean` / `dynamic`

| feature_set          |   #feat |   recall |   fp_rate |   precision |       f1 |   ส่งต่อ_stage2_% |   latency (ms/1k) |   threshold |
|:---------------------|--------:|---------:|----------:|------------:|---------:|----------------:|------------------:|------------:|
| attack7_intersection |       2 | 0.99156  |  0.326854 |    0.924316 | 0.956758 |         85.9301 |          0.189715 |    0.208945 |
| normal8_intersection |       2 | 0.99156  |  0.326854 |    0.924316 | 0.956758 |         85.9301 |          0.212252 |    0.208945 |
| attack7_mean         |      15 | 0.999437 |  0.000146 |    0.999964 | 0.9997   |         80.0605 |          0.19993  |    0.99     |
| normal8_mean         |      15 | 0.999474 |  7.3e-05  |    0.999982 | 0.999728 |         80.0619 |          0.219138 |    0.99     |
| binary_topk          |      15 | 0.999583 |  7.3e-05  |    0.999982 | 0.999782 |         80.0707 |          0.225302 |    0.99     |
| binary_dynamic       |      21 | 0.999619 |  7.3e-05  |    0.999982 | 0.9998   |         80.0736 |          0.225324 |    0.99     |
| attack7_union        |      37 | 0.999492 |  7.3e-05  |    0.999982 | 0.999737 |         80.0634 |          0.212    |    0.99     |
| normal8_union        |      39 | 0.999655 |  7.3e-05  |    0.999982 | 0.999818 |         80.0765 |          0.250786 |    0.99     |
| attack7_dynamic      |      40 | 0.999601 |  0.000146 |    0.999964 | 0.999782 |         80.0736 |          0.246559 |    0.99     |
| normal8_dynamic      |      41 | 0.999673 |  7.3e-05  |    0.999982 | 0.999828 |         80.0779 |          0.248644 |    0.99     |
| all_features         |      65 | 0.999583 |  7.3e-05  |    0.999982 | 0.999782 |         80.0707 |          0.244549 |    0.99     |
...
|:---------------------|-------------:|---------------:|---------------:|----------:|
| attack7_intersection |            2 |         0.9907 |         0.991  |    0.9916 |
| normal8_intersection |            2 |         0.9907 |         0.991  |    0.9916 |
| attack7_mean         |           15 |         0.9998 |         0.9965 |    0.9994 |
| binary_topk          |           15 |         0.9999 |         0.997  |    0.9996 |
| normal8_mean         |           15 |         0.9998 |         0.9962 |    0.9995 |
| binary_dynamic       |           21 |         0.9999 |         0.9969 |    0.9996 |
| attack7_union        |           37 |         0.9999 |         0.9961 |    0.9995 |
| normal8_union        |           39 |         0.9999 |         0.9961 |    0.9997 |
| attack7_dynamic      |           40 |         0.9999 |         0.9964 |    0.9996 |
| normal8_dynamic      |           41 |         0.9999 |         0.9961 |    0.9997 |
...
| attack7_mean         |      15 |   0.9975 |      0.9999 | 0.9987 |            0.1999 |
| normal8_mean         |      15 |   0.9981 |      0.9998 | 0.999  |            0.259  |
| binary_topk          |      15 |   0.9981 |      0.9999 | 0.999  |            0.2786 |
| binary_dynamic       |      21 |   0.9976 |      0.9999 | 0.9987 |            0.2292 |
| attack7_union        |      37 |   0.9981 |      0.9999 | 0.999  |            0.2413 |
| normal8_union        |      39 |   0.9978 |      0.9999 | 0.9988 |            0.2193 |
| attack7_dynamic      |      40 |   0.9979 |      0.9999 | 0.9989 |            0.2392 |
| normal8_dynamic      |      41 |   0.9979 |      0.9999 | 0.9989 |            0.2454 |
| all_features         |      65 |   0.9975 |      0.9999 | 0.9987 |            0.2867 |
...
|:---------------|:---------------|---------:|---------------:|------------------:|-----------------------:|---------------:|----------------:|-----------------:|--------------:|------------------:|-----------------------:|---------------:|----------------:|
| BFA            | ใช่             |      295 |         1      |            1      |                 0.5051 |         1      |          1      |           1      |        1      |            1      |                 0.5051 |         1      |          1      |
| DDoS           | ใช่             |    73529 |         1      |            1      |                 0.7275 |         0.9995 |          1      |           1      |        1      |            1      |                 0.7275 |         1      |          1      |
| DoS            | ใช่             |     1145 |         0.7397 |            0.7563 |                 0.0856 |         0.7336 |          0.7825 |           0.7616 |        0.7843 |            0.7555 |                 0.0856 |         0.7825 |          0.745  |
| Probe          | ใช่             |    61757 |         0.9994 |            0.9999 |                 0.7558 |         0.9999 |          0.9999 |           0.9992 |        0.9999 |            0.9999 |                 0.7558 |         0.9999 |          0.9999 |
| U2R            | ไม่ (zero-shot) |       17 |         0.9412 |            1      |                 0.5882 |         1      |          1      |           0.9412 |        1      |            1      |                 0.5882 |         1      |          1      |
...
|:---------------------|-------------:|-------:|------------:|---------:|------------------:|-----------------:|
| attack7_intersection |            2 | 0.7637 |      0.9629 |   0.6959 |            1.0718 |          79.8572 |
| normal8_intersection |            2 | 0.7637 |      0.9629 |   0.6959 |            1.0855 |          79.8572 |
| attack7_mean         |           15 | 0.9377 |      0.9301 |   0.9623 |            0.8689 |          98.056  |
| normal8_mean         |           15 | 0.9452 |      0.9914 |   0.9117 |            1.0667 |          98.8398 |
| binary_topk          |           15 | 0.9354 |      0.9302 |   0.9575 |            0.9798 |          97.8121 |
| binary_dynamic       |           21 | 0.9725 |      0.9885 |   0.9591 |            0.991  |         101.696  |
| attack7_union        |           37 | 0.9061 |      0.9041 |   0.9198 |            0.8964 |          94.7504 |
| normal8_union        |           39 | 0.9567 |      0.953  |   0.9675 |            0.9057 |         100.039  |
| attack7_dynamic      |           40 | 0.9421 |      0.9327 |   0.9679 |            0.9554 |          98.5189 |
| normal8_dynamic      |           41 | 0.9056 |      0.9036 |   0.9193 |            1.0403 |          94.6978 |
| all_features         |           65 | 0.9563 |      0.9535 |   0.9664 |            0.976  |         100      |
